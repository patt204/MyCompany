...
public class FakturaWydanie {
	...
	public FakturaWydanie( String data, String nazwaFaktury, String wystawiajacy, String odbiorca, String platnosc, String oplataDo, String sumaTowarow) {
		super();
		this.data = data;
	...
	public String toString() {
		return "FakturaPrzyjecie [data=" + data + ", nazwaFaktury=" + nazwaFaktury + ", wystawiajacy=" + wystawiajacy + ", odbiorca=" + odbiorca  + ", platnosc=" + platnosc  + ", oplataDo=" + oplataDo + ", sumaTowarow=" + sumaTowarow + "]";
	}
